...
export default class WebviewTC extends Component {
    render() {
        return (
            <View style={styles.container}>
                <HeaderBar pageName='Terms And Conditions' navigation={this.props.navigation} />
                <WebView
                    source={{ uri: 'http://139.59.69.143/TermsAndConditions.html' }}
                />
            </View>
        );
    }
